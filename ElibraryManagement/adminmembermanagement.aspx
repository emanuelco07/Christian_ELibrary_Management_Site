                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox class="form-control" ID="TextBox1" runat="server"
                                        placeholder="Full Name" TextMode="SingleLine" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-5">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <asp:TextBox class="form-control me-1" ID="TextBox7" runat="server"
                                            placeholder="Status" TextMode="SingleLine" ReadOnly="True"></asp:TextBox>
                                        ...
                                        <asp:LinkButton class="btn btn-warning me-1" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click"><i class="fa-solid fa-pause"></i></asp:LinkButton>
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox class="form-control" ID="TextBox10" runat="server"
                                        placeholder="Full Postal Adress" ReadOnly="True" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-8 mx-auto">
                                <div class="mb-3">
                                    <asp:Button class="btn btn-danger d-block w-100 btn-lg" ID="Button1" runat="server" Text="Delete User Permanently" OnClick="Button1_Click" />
                                </div>
                            </div>
                        </div>

                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" height="150px" width="100px" src="imgs/books2.png" />
                                </center>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox class="form-control" ID="TextBox1" runat="server"
                                        placeholder="Book Name" TextMode="SingleLine"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox class="form-control" ID="TextBox3" runat="server"
                                        placeholder="Publish Date" TextMode="Date"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:ListBox class="form-control" ID="ListBox1" runat="server" SelectionMode="Multiple" Rows="4">
                                    ...
                                    <asp:ListItem Text="Biblical Studies" Value="BiblicalStudies" />
                                    <asp:ListItem Text="Christian Living" Value="ChristianLiving" />
                                    <asp:ListItem Text="Spiritual Growth" Value="SpiritualGrowth" />
                                    <asp:ListItem Text="Devotionals" Value="Devotionals" />
                                    <asp:ListItem Text="Theology" Value="Theology" />
                                    <asp:ListItem Text="Apologetics" Value="Apologetics" />
                                    <asp:ListItem Text="Church History" Value="ChurchHistory" />
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox class="form-control" ID="TextBox7" runat="server"
                                        placeholder="Current Stock" ReadOnly="true" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <asp:TextBox class="form-control" ID="TextBox8" runat="server"
                                        placeholder="Issued Books" ReadOnly="true" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    <asp:Button class="btn btn-success d-block w-100 btn-lg" ID="Button2" runat="server" Text="Add" OnClick="Button2_Click" />
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <asp:Button class="btn btn-danger d-block w-100 btn-lg" ID="Button1" runat="server" Text="Delete" OnClick="Button1_Click" />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-lg-10" font-size="X-Large">
                                                            <div class="row">
                                                                <div class="col-12">

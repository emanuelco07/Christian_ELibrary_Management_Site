                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <asp:Button class="btn btn-primary d-block w-100 btn-lg" ID="Button1" runat="server" Text="Issue" OnClick="Button1_Click" />
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <asp:Button class="btn btn-success d-block w-100 btn-lg" ID="Button4" runat="server" Text="Return" OnClick="Button4_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
